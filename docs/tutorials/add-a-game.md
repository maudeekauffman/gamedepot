...
In this tutorial, you will learn how to add a new game to the GameDepot database using Postman.
...
2. Change the request method from **GET** to **POST** using the drop-down list.
3. Enter this URL:
```
